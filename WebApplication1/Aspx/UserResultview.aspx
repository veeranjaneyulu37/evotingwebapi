<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserResultview.aspx.cs" Inherits="WebApplication1.Aspx.UserResultview" %>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header" id="headertext">
                    
                    <h3 class="card-title">Total no of voters in thatstate </h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                        <canvas id="barchartmla"></canvas>
                    </div>
                </div>
            </div>
        </div>
